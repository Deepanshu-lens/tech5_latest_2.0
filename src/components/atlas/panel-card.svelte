...
<article
  class={`flex  items-center gap-4 p-4 dark:border hover:border hover:border-brand-foreground dark:hover:border-brand rounded-xl shadow-md text-base z-10 w-full px-4
...
>
  ...
  <ul class="flex flex-row gap-2 ml-auto p-0 list-none cursor-pointer">
    <!-- svelte-ignore a11y-click-events-have-key-events -->
    <!-- svelte-ignore a11y-no-noninteractive-element-interactions -->
    <DeletePanel {panelData} name={panelData?.name} >
